...
public class ArtistSongs extends AppCompatActivity {
        ...
        private class List_All_Songs extends AsyncTask<Void, Integer, ArrayList<Song>> {
            ...
            protected void onPostExecute(ArrayList<Song> c) {
                ...
                if(album_songs_list!= null) {
                    ...
                    ArtistAdapter songAdt = new ArtistAdapter(context, album_songs_list);
            ...
            private void getalbum_songs_list(){
                ...
                if(mediaCursor != null && mediaCursor.moveToFirst())
                {
                    ...
                    int artist_id=mediaCursor.getColumnIndex(MediaStore.Audio.Media.ARTIST_ID);
                    ...
                    do
                    {
                        ...
                        long artistId=mediaCursor.getLong(artist_id);
        ...
        public class ArtistAdapter extends BaseAdapter {
            ...
            private ArtistAdapter(Context c, ArrayList<Song> theSongs) {
                songs = theSongs;
